...
#### Set features used for the analysis ----
# Extracted during charging from within the voltage interval
window_capacity_features <- c(
    ...
    "Current_Kurtosis",
    "Current_MAD",
    #"FEC", # <- Uncomment to and re-run to allow FEC as a feature 
    "SOHW", 
    "Ri",
    "Temperature"
)

# Extracted during charging from before the voltage interval
...
# Extracted during dynamic discharging from before the partial charge
...
if (create_trainingset) {
    ...
    ## Fixing missing features which occur when the voltage windows starts immediately after discharging.
    ...
    ## Saving complete data-set, with random training/validation split, and standardised features.
